...
from utils.util import get_mnist_data, get_mnist_m_data, get_svhn_data, get_usps_data, add_watermark, get_augment_data
...
SOURCE = 'svhn'   # mnist, usps, svhn, mnist_m
...
def train():
    ...
    PATH = 'D:/WLY/Documents/NUAA/CVPR/github/' + SOURCE + '_author' + '.pth'

    datafile = Cus_Dataset(mode='author', dataset_1=dataset_patch, begin_ind1=0, size1=5000,
                                          dataset_2=dataset, begin_ind2=0, size2=5000,
                                          dataset_3=dataset_aug, begin_ind3=0, size3=5000,
                                          dataset_4=dataset_aug_patch, begin_ind4=0, size4=5000)
    ...
    for i in datasets:
        datafile_val = Cus_Dataset(mode='val', dataset_1=i, begin_ind1=5000, size1=1000)
    ...
    for epoch in range(nepoch):
        for i, (img1, label1, img2, label2) in enumerate(dataloader):
            ...
            out1, out2, a1, a2 = model(img1, img2, i)
